...
public class LevelOneIntroDialogue : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        dialogTexts.Add(new DialogData("You pound every button on the panel, but the elevator only seems to want to go up one floor at a time.", "Narrator"));
        ...
        dialogTexts.Add(new DialogData("She takes a moment to compose herself.", "Narrator"));
