...
public class LevelFiveIntro : MonoBehaviour {
    ...
    void Awake() {
        ...
        dialogTexts.Add(new DialogData("You take a step off the elevator, but find you cannot take another. The darkness clears, revealing those you have met here and a horrifying mess of flesh and machine on the ground.", "Narrator"));
        ...
        dialogTexts.Add(new DialogData("They said you needed them to build yourself. If that’s true, let them go.", "Protagonist"));
