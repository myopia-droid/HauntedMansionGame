...
public class MessageP2End : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        dialogTexts.Add(new DialogData("I have good news, though. According to the library records, a map of the manor was checked out by Dr. Edwards, and his office is only one floor above.", "Younggirl"));
