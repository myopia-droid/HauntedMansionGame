...
public class playerController : MonoBehaviour {
  ...
  public bool knockFromRight;
    ...
    void Update() {
      ...
      if (Input.GetKeyDown(KeyCode.UpArrow) || Input.GetKeyDown(KeyCode.W) && doubleJump > 0) {
        anim.SetTrigger("takeoff");
        rb.velocity = Vector2.up * jumpForce;
        doubleJump--;
      } else if (Input.GetKeyDown(KeyCode.UpArrow) || Input.GetKeyDown(KeyCode.W) && doubleJump == 0 && isGrounded == true) {
        anim.SetTrigger("takeoff");
        rb.velocity = Vector2.up * jumpForce;
      }
