...
public class MessageP2 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        dialogTexts.Add(new DialogData("Oh. Well, m-make sure you’re warm. The fire’s long\ngone out.", "Younggirl"));
        dialogTexts.Add(new DialogData("You look freezing cold. Aren’t there any blankets I could get you?", "Protagonist"));
        dialogTexts.Add(new DialogData("I gathered some bolts of curtain fabric to stitch into a\ncoat, but I saw a spider so I dropped them and ran.", "Younggirl"));
        dialogTexts.Add(new DialogData("T-that was somewhere in non-fiction, I think, but I’ve\nbeen too scared to go back.", "Younggirl"));
        dialogTexts.Add(new DialogData("I can go get them for you.", "Protagonist"));
        dialogTexts.Add(new DialogData("That’s very kind of you.You said y-you were lost, did\nyou not?", "Younggirl"));
        DialogData finalLine = new DialogData("This is the records section, so I can try to find a map\nof the manor for you. Good journey, traveller.", "Younggirl");
